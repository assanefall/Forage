        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('compteurs.store')}}">
                    ...
                    <div class="form-group">
                        <label for="input-nom">Numero serie</label>
                        <input type="text" name="numserie" class="form-control" id="input-numserie" aria-describedby="emailHelp" placeholder="Numero serie du compteur">
