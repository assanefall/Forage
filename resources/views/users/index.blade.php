...
<div class="content">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Êtes-vous sûr de bien vouloir supprimer ce utilisateurs</h5>
      ...
      $(document).ready(function () {
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        return '<a href='+url_e+'  class=" btn btn-primary " ><i class="material-icons">edit</i></a>'+
                         '<div class="btn btn-danger delete btn-delete-user"  data-href='+url_d+'><i class="material-icons">delete</i></div>';
          ...
          $('#table-user').off('click', '.btn-delete-user').on('click', '.btn-delete-user', 
          function(){
