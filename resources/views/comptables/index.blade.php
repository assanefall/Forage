...
<div class="content">
       ...
       <!-- Modal-delete-comptable -->
       <div class="modal" id="modal-delete-comptable" tabindex="-1" role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Êtes-vous sûr de bien vouloir supprimer ce comptable</h5>
      ...
      $(document).ready(function () {
          $('#table-comptables').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        '<div class="btn btn-danger delete btn-delete-comptable"  data-href='+url_d+'><i class="material-icons">delete</i></div>'; 
                        },
                        "targets": 4
                        },
                    // {
          ...
          $('#table-comptables').off('click', '.btn-delete-comptable').on('click', '.btn-delete-comptable', 
          function(){
